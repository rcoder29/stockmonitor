...
const GUIDE = [
  {
    ...
    blocks: [
      ...
      { type: 'table', headers: ['Group', 'What\'s Inside'], rows: [
        ...
        ['Research', 'Screener, Fundamentals, DCF Valuation, Chart Compare, Backtester, Earnings Surprise, Earnings Strategy, Analyst Ratings, Relative Strength, Seasonal Patterns, ETF Overlap, Signals, Unusual Options'],
