...
const GUIDE = [
  {
    ...
    blocks: [
      ...
      { type: 'table', headers: ['Group', 'What\'s Inside'], rows: [
        ...
        ['Research', 'Screener, Fundamentals, DCF Valuation, Chart Compare, Backtester, Earnings Surprise, Signals, Unusual Options'],
        ...
        ['Portfolio', 'Portfolio, Options P&L, Tax Lots, Dividend Tracker, Stress Test, Trade Journal'],
