...
const GUIDE = [
  {
    ...
    blocks: [
      ...
      { type: 'table', headers: ['Group', 'What\'s Inside'], rows: [
        ['Markets', 'Overview, Index Heatmap, Breadth, Sector Rotation, Sector Momentum, Yield Curve, Fed Watch, Macro Calendar, Analyst Picks, Short Squeeze, IPO & Lockups, Insider Trading, Crypto'],
        ...
        ['Portfolio', 'Portfolio, Options P&L, Tax Lots, Trade Journal'],
        ['AI Tools', 'Morning Briefing, Portfolio Review, Financial Advisor, Tax Advisor, AI Chat'],
