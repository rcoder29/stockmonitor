...
const GUIDE = [
  {
    ...
    blocks: [
      ...
      { type: 'p', text: 'The left sidebar organises all features into 7 groups. Click a group header to collapse or expand it. Click any item to load that view. The ? User Guide button is always pinned to the bottom of the sidebar. On mobile, tap ☰ to open the sidebar drawer.' },
      { type: 'table', headers: ['Group', 'What\'s Inside'], rows: [
        ['Markets', 'Overview, Analyst Picks, Breadth, Index Heatmap, Sector Rotation, Sector Momentum, Macro Calendar, Yield Curve'],
        ...
        ['Trading', 'Day Trader, Trade Ideas, Position Sizer'],
        ['AI Tools', 'AI Chat, Financial Advisor'],
        ['Retirement', 'FIRE Calculator, Monte Carlo, Coast FIRE & Roth, Social Security'],
      ]},
  ...
  },
  {
    ...
    icon: '⏱',
    blocks: [
      { type: 'p', text: 'Four tools for FIRE (Financial Independence, Retire Early) and retirement planning — covering accumulation, withdrawal risk, fund access strategy, and Social Security optimisation.' },
