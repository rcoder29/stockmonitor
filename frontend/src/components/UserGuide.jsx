...
const GUIDE = [
  {
    ...
    blocks: [
      ...
      { type: 'p', text: 'The left sidebar organises all features into 6 groups. Click a group header to collapse or expand it. Click any item to load that view. The ? User Guide button is always pinned to the bottom of the sidebar. On mobile, tap ☰ to open the sidebar drawer.' },
