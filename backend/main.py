...
def _search_bond_prospectus(ticker: str) -> list[dict]:
...
@app.get('/api/bonds/ratings-mentions/{ticker}')
...
@app.get('/api/merger/opportunities')
...
@app.put('/api/merger/positions/{position_id}')
...
@app.delete('/api/merger/positions/{position_id}')
...
@app.put('/api/spac/deals/{deal_id}')
...
@app.delete('/api/spac/deals/{deal_id}')
